...
ThreeToteAuto::ThreeToteAuto()
{
	...
	AddSequential(new IntakeArmsOpenCommand());         			//Prepare
	...
	AddSequential(new DriveForDistance(24, .50));            		//Drive until touching second tote
	AddParallel(new IntakeArmsCloseCommand());          			//Close intake arms around second tote
	...
	AddParallel(new IntakeArmsCloseCommand());          			//Close intake arms around third tote
